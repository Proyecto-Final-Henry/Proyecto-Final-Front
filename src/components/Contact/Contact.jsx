...
function Contact() {
    return (
      <div>
        ...
        <div>
            <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque maxime quae laborum consequuntur repellendus, soluta velit possimus non voluptates vitae itaque eaque molestias reprehenderit ea illo assumenda quibusdam illum blanditiis?</h4>
            <h4>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut impedit, dolorem nulla nesciunt eos placeat ex debitis, totam ab, facere velit pariatur assumenda veritatis omnis.</h4>
        </div>
